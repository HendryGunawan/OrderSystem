...
<div class="container">
  ...
  <div id="Checkout" class="inline">
      ...
      <h1>Pesanan Rolling Door Sparepart</h1>
        ...
        columns: [
            ...
            { data: 'grand_total', name: 'grand_total' },
            {
                ...
                mRender: function (data, type, full) {
                  ...
                  return '<a class="btn2" href="{{ route('rolling_door_sparepart_order_view') }}?id=' + full.id + '">LIHAT</a>\
                          <a class="btn2" href="{{ route('rolling_door_sparepart_order_edit') }}?id=' + full.id + '">EDIT</a>\
                          <a class="btn2" href="{{ route('rolling_door_sparepart_order_delete') }}?id=' + full.id + '">HAPUS</a>\
