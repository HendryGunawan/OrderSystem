...
<div class="container">
  <div id="Checkout" class="inline">
      <h1>Lihat Pesanan Rolling Door</h1>
      <form id="rolling-door-order-view" method="POST" action="#" role="form">
      {{ csrf_field() }}
              ...
              <tbody>
                  ...
                  foreach($child as $key => $child_value)
                  {
                    ...
                    <tr data-id="<?php echo $key ?>">
                      ...
                      <td>
                          <input type="text" class="form-control" name="order[<?php echo $key ?>][RollingDoorSparepartName]" min="0" value="<?php echo $child_value['ItemName'] ?>" readonly>
                      </td>
                      <td>
