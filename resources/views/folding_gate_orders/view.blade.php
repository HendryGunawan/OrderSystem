...
<div class="container">
  <div id="Checkout" class="inline">
      <h1>Lihat Pesanan Folding Gate</h1>
      <form id="folding-gate-order-view" method="POST" action="#" role="form">
      {{ csrf_field() }}
              ...
              <tbody>
                  ...
                  foreach($child as $key => $child_value)
                  {
                    ...
                    <tr data-id="<?php echo $key ?>">
                      ...
                      <td>
                          <input type="text" class="form-control" name="order[<?php echo $key ?>][FoldingGateName]" min="0" value="<?php echo $child_value['ItemName'] ?>" readonly>
                      </td>
                      <td>
