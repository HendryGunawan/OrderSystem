...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form id="folding-gate-order-edit" method="POST" action="{{ route('folding_gate_order_edit_post') }}" role="form">
      {{ csrf_field() }}
              ...
              <tbody>
                  ...
                  foreach($child as $key => $child_value)
                  {
                    ...
                    <tr data-id="<?php echo $key ?>">
                      <td>
                          <select name="order[<?php echo $key ?>][folding_gate_id]" class="form-control" onclick="checkprice(this)">
                              <option value=""></option>
                              <?php
