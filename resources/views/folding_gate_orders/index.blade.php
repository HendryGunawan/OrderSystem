...
<div class="container">
  ...
  <div id="Checkout" class="inline">
      ...
      <h1>Folding Gate Order Items</h1>
        ...
        columns: [
            ...
            { data: 'grand_total', name: 'grand_total' },
            {
                ...
                mRender: function (data, type, full) {
                  ...
                  return '<a class="btn2" href="{{ route('folding_gate_order_view') }}?id=' + full.id + '">VIEW</a>\
                          <a class="btn2" href="{{ route('folding_gate_order_edit') }}?id=' + full.id + '">EDIT</a>\
                          <a class="btn2" href="{{ route('folding_gate_order_delete') }}?id=' + full.id + '">DELETE</a>\
